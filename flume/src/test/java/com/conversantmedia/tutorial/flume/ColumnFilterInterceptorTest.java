...
public class ColumnFilterInterceptorTest extends TestCase {
	...
	public void testIntercept() throws Exception {
		...
		ctx.put("type", "com.conversantmedia.tutorial.flume.ColumnFilterInterceptor$Builder");
		ctx.put("columns", "1,4,7");
		Interceptor.Builder builder = InterceptorBuilderFactory.newInstance("com.conversantmedia.tutorial.flume.ColumnFilterInterceptor$Builder");
